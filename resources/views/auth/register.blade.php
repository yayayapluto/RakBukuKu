...
<!-- Register form start -->
<form action="{{route('do_register')}}" method="POST" enctype="multipart/form-data" class="max-w-md mx-auto bg-white p-6 rounded-lg">
    @csrf
    @method('POST')

    <div class="mb-3">
        <label for="nama" class="block text-xs font-medium text-blue">Nama:</label>
    ...
    <div class="mb-3">
        <label for="email" class="block text-xs font-medium text-blue">Email:</label>
    ...
    <div class="mb-3">
        <label for="password" class="block text-xs font-medium text-blue">Kata Sandi:</label>
    ...
    <div class="mb-3">
        <label for="tempat_lahir" class="block text-xs font-medium text-blue">Tempat Lahir:</label>
    ...
    <div class="mb-3">
        <label for="tanggal_lahir" class="block text-xs font-medium text-blue">Tanggal Lahir:</label>
    ...
    <div class="mb-3">
        <label for="jenis_kelamin" class="block text-xs font-medium text-blue">Jenis Kelamin:</label>
    ...
    <div class="mb-3">
        <label for="alamat" class="block text-xs font-medium text-blue">Alamat:</label>
    ...
    <div class="mb-3">
        <label for="telepon" class="block text-xs font-medium text-blue">Telepon:</label>
    ...
    <div class="mb-3">
        <label for="foto" class="block text-xs font-medium text-blue">Foto:</label>
        <input id="foto" name="foto" type="file" class="mt-1 block w-full text-xs text-gray-500">
    </div>

    <div class="text-center">
        <button type="submit" class="inline-flex justify-center w-full px-2 py-1 border border-transparent shadow-sm text-xs font-medium rounded-md text-white bg-blue hover:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
            Daftar
        </button>
    </div>
